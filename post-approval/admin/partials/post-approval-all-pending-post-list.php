            ...
            if ($review_posts) {
               foreach ($review_posts as $post) {
                  ...
                  if (user_post_comment($post->ID)) {
                     $comment_data .= '<a href="#TB_inline?width=600&height=400&inlineId=modal-window-' . $post->ID . '" class="thickbox" title="User post comments">View User comment</a>';
                     add_thickbox();
